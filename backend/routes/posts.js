//config file which is responsible for saving, adding and deleting posts.
...
// Map which specifies which mime types are allowed in the application (this is required for the image upload).
const MIME_TYPE_MAP = {
    'image/png': 'png',
    'image/jpeg': 'jpg',
    'image/jpg': 'jpg',
